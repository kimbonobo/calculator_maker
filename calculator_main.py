...
class Main(QDialog):
    ...
    def init_ui(self):
        ...
        layout_dog.addWidget(button_plus)
        layout_dog.addWidget(button_minus)
        layout_dog.addWidget(button_product)
        layout_dog.addWidget(button_division)
